...
MSFT_data <-function(train_table1,train_table2,train_table3,train_table4,train_table5,train_table6){
  ...
  fitting_test_factors_MSFT(test_table1)
  fitting_test_factors_MSFT(test_table2)
  #fitting_test_factors_MSFT(test_table3)
  #fitting_test_factors_MSFT(test_table4)
  #fitting_test_factors_MSFT(test_table5)
  #fitting_test_factors_MSFT(test_table6)
}
...
GOOGL_data <-function(train_table1,train_table2,train_table3,train_table4,train_table5,train_table6){
  ...
  fitting_test_factors_GOOGL(test_table1)
  fitting_test_factors_GOOGL(test_table2)
  #fitting_test_factors_GOOGL(test_table3)
  #fitting_test_factors_GOOGL(test_table4)
  #fitting_test_factors_GOOGL(test_table5)
  #fitting_test_factors_GOOGL(test_table6)
}
...
VZ_data <-function(train_table1,train_table2,train_table3,train_table4,train_table5,train_table6){
  ...
  fitting_test_factors_VZ(test_table1)
  fitting_test_factors_VZ(test_table2)
  #fitting_test_factors_VZ(test_table3)
  #fitting_test_factors_VZ(test_table4)
  #fitting_test_factors_VZ(test_table5)
  #fitting_test_factors_VZ(test_table6)
}
...
BIDU_data <-function(train_table1,train_table2,train_table3,train_table4,train_table5,train_table6){
  ...
  fitting_test_factors_BIDU(test_table1)
  fitting_test_factors_BIDU(test_table2)
  #fitting_test_factors_BIDU(test_table3)
  #fitting_test_factors_BIDU(test_table4)
  #fitting_test_factors_BIDU(test_table5)
  #fitting_test_factors_BIDU(test_table6)
}
BIDU_data(train_table1,train_table2,train_table3,train_table4,train_table5,train_table6)
